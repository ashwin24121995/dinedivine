      ...
      <div className="min-h-screen bg-[#0a0f1a]">
        ...
        <div className="max-w-2xl mx-auto px-4 py-16">
          <div className="bg-[#1a2332] rounded-xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-300 mb-6">{squadMessage}</p>
      ...
      <div className="bg-[#1a2332] border-b border-[#22c55e]/20">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-center gap-4">
            <div className={`flex items-center gap-2 ${step === "select" ? "text-[#22c55e]" : "text-gray-300"}`}>
            ...
            <div className={`flex items-center gap-2 ${step === "captain" ? "text-[#22c55e]" : "text-gray-300"}`}>
            ...
            <div className="w-12 h-0.5 bg-gray-200"></div>
            <div className={`flex items-center gap-2 ${step === "preview" ? "text-[#22c55e]" : "text-gray-300"}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <div>
                <p className="text-xs text-gray-300">Credits Left</p>
            ...
            <div className="flex items-center gap-4">
              {Object.entries(ROLE_LIMITS).map(([role, limit]) => (
                <div key={role} className="text-center">
                  ...
                  <p className={`font-bold ${getSelectedByRole(role) >= limit.min ? "text-[#22c55e]" : "text-gray-300"}`}>
        ...
        {step === "select" && (
          <>
            ...
            <div className="flex flex-wrap gap-4 mb-6">
              <div className="flex gap-2">
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium ${activeTeamTab === 0 ? "bg-[#22c55e] text-white" : "bg-[#1a2332] text-gray-300 border"}`}
                >
                  All
                </button>
                {squads.map((squad, index) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium ${activeTeamTab === index + 1 ? "bg-[#22c55e] text-white" : "bg-[#1a2332] text-gray-300 border"}`}
                  >
              ...
              <div className="flex gap-2">
                {["ALL", "WK", "BAT", "AR", "BOWL"].map((role) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium ${activeRoleTab === role ? "bg-blue-600 text-white" : "bg-[#1a2332] text-gray-300 border"}`}
                  >
                    {role}
                  </button>
                ))}
            ...
            <div className="bg-[#1a2332] rounded-xl shadow-sm border border-[#22c55e]/20">
              <div className="grid grid-cols-12 gap-4 p-4 border-b border-[#22c55e]/20 text-sm font-medium text-gray-300">
                  ...
                  >
                    <div className="col-span-5 flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-300">{squads[player.teamIndex]?.shortname}</p>
                      </div>
                    </div>
                    <div className="col-span-2 flex items-center justify-center">
                      <span className="px-2 py-1 bg-[#1a2332] text-gray-300 text-xs rounded-full">
                    ...
                    <div className="col-span-1 flex items-center justify-center">
                      <span className={`w-6 h-6 rounded-full flex items-center justify-center text-sm ${
                        isSelected ? "bg-[#22c55e] text-white" : "bg-gray-200 text-gray-300"
                      }`}>
                        {isSelected ? "✓" : "+"}
                      </span>
                    </div>
        ...
        {step === "captain" && (
          <>
            <div className="text-center mb-6">
              ...
              <p className="text-gray-300">Captain gets 2x points, Vice Captain gets 1.5x points</p>
            </div>
        ...
        {step === "preview" && (
          <>
            <div className="text-center mb-6">
              ...
              <p className="text-gray-300">Review your team before saving</p>
            </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {selectedPlayers.map((player) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-300">{getRoleFromPlayer(player.role)} • {player.credits} cr</p>
                  </div>
                ))}
              </div>
            </div>
