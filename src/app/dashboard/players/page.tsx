    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Search and view detailed player statistics</p>
        </div>
          ...
          <div className="flex gap-4">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full px-4 py-3 pl-12 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
              />
              <svg
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
            <div className="text-6xl mb-4">🏏</div>
            <h3 className="text-xl font-bold text-gray-800 mb-2">Search for Players</h3>
            <p className="text-gray-500">Enter a player name above to view their stats and information</p>
          </div>
        )}
      </div>
    </div>
