...
var wheelOuterContainer,wheelInnerContainer,lightsContainer,ticketContainer;
var wheelContainer,wheelPinContainer;
var buttonStart,bgWheel,itemWheel,itemWheelCentre,itemArrow,itemPin,itemSide,itemGame1,itemGame2,buttonSpin,buttonPlus,buttonMinus,itemStatusBg,statusTxt,instructionTxt,itemLightData,itemLightAnimate,itemTicket,itemTicketMask,chanceTxt,betTxt,creditTxt,itemResultSide,resultScoreTxt,buttonYes,buttonNo;
$.wheel = {};
$.wheelInner = {};
$.ticket = {};
$.light = {};
...
function buildGameCanvas(){
	...
	shareContainer.x = shareSaveContainer.x = canvasW/100 * 28;
    shareContainer.y = shareSaveContainer.y = canvasH/100 * 49.5;
	...
	resultContainer.addChild(itemResultSide, resultTitleTxt, resultScoreTxt, buttonReplay, shareContainer, shareSaveContainer);
	
	
	canvasContainer.addChild(bg, wheelContainer, mainContainer, gameContainer, resultContainer, exitContainer, optionsContainer, buttonSettings, guideline);
