...
var roomContainer, nameContainer, gameLogsTxt, buttonLocal, buttonOnline;
var buttonLocalContainer, buttonStart, ballsContainer, historyBallContainer, bingoContainer, playerContainer, otherPlayersContainer, winPatternContainer, powerContainer, powerBadgeContainer, starContainer;
var itemGame, itemBingo, itemBingoMini, buttonBingo, buttonBingoWin, itemSelect, itemSelectWin, itemSelectSmall, itemSelectWinSmall, itemBallB, itemBallI, itemBallN, itemBallG, itemBallO, historyMask, itemWin, itemStar, ballStatusTxt, ballStatusShadowTxt, bingoStatusTxt, bingoStatusShadowTxt, itemPowerBlank, itemPowerFill, powerMask, itemPowerBadge, itemBallPower;
var itemResult;
...
function buildGameCanvas(){
	...
	resultContainer.addChild(itemResult, resultTitleTxt, buttonContinue, shareContainer, shareSaveContainer);
	
	canvasContainer.addChild(bg, mainContainer, nameContainer, roomContainer, gameContainer, resultContainer, starContainer, gameLogsTxt, exitContainer, optionsContainer, buttonSettings, guideline);
